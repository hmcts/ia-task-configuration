...
class CamundaTaskConfigurationTest extends DmnDecisionTableBaseUnitTest {
    ...
    @ParameterizedTest
    @CsvSource({
        "processApplication", "processApplicationAdjourn", "processApplicationExpedite",
        "processApplicationTimeExtension", "processApplicationTransfer", "processApplicationWithdraw",
        "processApplicationUpdateHearingRequirements", "processApplicationUpdateAppealDetails",
        "processApplicationReinstateAnEndedAppeal", "processApplicationOther",
