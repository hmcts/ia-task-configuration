...
class CamundaTaskConfigurationTest extends DmnDecisionTableBaseUnitTest {
    ...
    private static Stream<Arguments> workTypeScenarioProviderGetter(boolean is24w) {
        ...
        return Stream.of(
            ...
            argumentsCreator("reviewAddStf24wFlag", routineWork, is24w),
            argumentsCreator("reviewRemoveStf24wFlag", routineWork, is24w),
    ...
    @CsvSource({
        ...
        "reviewAddStf24wFlag","reviewRemoveStf24wFlag"
    })
    ...
    @CsvSource({
        ...
        "reviewAddStf24wFlag,Stf 24 flag has been added to the case. Please review the appeal,,,",
        "reviewRemoveStf24wFlag,Stf 24 flag has been removed from the case. Please review the appeal,,,"
    ...
    public static Stream<Arguments> dueDateIntervalDaysScenarioProvider() {
        ...
        return Stream.of(
            ...
            Arguments.of("reviewAddStf24wFlag", twoDays),
            Arguments.of("reviewRemoveStf24wFlag", twoDays),
